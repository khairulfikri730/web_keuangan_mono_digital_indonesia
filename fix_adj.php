...
// We want to replace lines 1455 to 1720 (0-indexed: 1454 to 1719)
// Let's verify what's at 1454
echo "Line 1455: " . trim($lines[1454]) . "\n";
echo "Line 1720: " . trim($lines[1719]) . "\n";
echo "Line 1721: " . trim($lines[1720]) . "\n";

$before = array_slice($lines, 0, 1454);
$after = array_slice($lines, 1720);
...
$combined = array_merge($before, $newLines, $after);

file_put_contents($file, implode("", $combined));
